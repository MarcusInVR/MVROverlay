const ui = (() => {
	...
	const beatmap = (() => {
		...
		return (data, time) => {
			...
			// WoW like colors for difficulty
			if (data.difficulty == "Easy")    { difficulty.className = "difficulty-easy"; }
			if (data.difficulty == "Normal")  { difficulty.className = "difficulty-normal"; }
			if (data.difficulty == "Hard")    { difficulty.className = "difficulty-hard"; }
			if (data.difficulty == "Expert")  { difficulty.className = "difficulty-expert"; }
			if (data.difficulty == "Expert+") { difficulty.className = "difficulty-expertplus"; }
